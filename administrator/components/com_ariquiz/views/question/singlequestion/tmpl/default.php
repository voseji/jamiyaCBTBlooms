	...
	<tbody>
		<tr id="trQueTemplate">
			...
			<td style="text-align:left;">
				...
				<?php $edt=& JFactory::getEditor();
            $params =array( 'smilies'=> '0', 'style' => '0', 'layer' => '0', 'id' =>'tbxAnswer');
            echo  $edt->display( 'tbxAnswer', $html, '100', '100', '1', '1', false, $params );
            
			if ($this->basedOnBank) echo 'disabled="true"'; ?>
				<?php 
					if (!$this->basedOnBank):
				?>
				<br />
...
<script type="text/javascript">
	...
	YAHOO.ARISoft.widgets.multiplierControls.init('trQueTemplate', 'tblQueContainer', 5, <?php echo WebControls_MultiplierControls::dataToJson($specificQuestion->getDataFromXml($questionData, false, $questionOverridenData)); ?>,
		function()
		{
