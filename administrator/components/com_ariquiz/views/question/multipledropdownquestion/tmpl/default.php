...
<table class="questionContainer" cellpadding="0" cellspacing="0">
    <tr>
        <td class="colMin right"><label for="chkRandomizeOrder"><?php echo JText::_('COM_ARIQUIZ_LABEL_RANDOMORDER'); ?></label></td>
        <td class="left"><input type="checkbox" id="chkRandomizeOrder" name="chkRandomizeOrder" value="1" <?php if (!empty($extraData['randomizeOrder'])) echo 'checked="checked" '; ?><?php if ($this->basedOnBank) echo ' disabled="disabled"'; ?>/></td>
    </tr>
</table>
...
<table class="questionNote" cellpadding="0" cellspacing="0">
    <tr>
        ...
        <td><?php echo JText::_('COM_ARIQUIZ_MESSAGE_MDDNOTE'); ?></td>
    </tr>
</table>
