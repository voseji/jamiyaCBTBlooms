...
class AriQuizCSVImportMultipleDropdownQuestion extends AriQuizCSVImportQuestionBase
{
    var $_type = 'MultipleDropdownQuestion';
    ...
    function getXml($data)
    {
        ...
        if ($random)
            $_REQUEST['chkRandomizeOrder'] = '1';
        else
        {
            JRequest::setVar('chkRandomizeOrder');
        }
