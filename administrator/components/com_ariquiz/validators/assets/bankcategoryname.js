(function(){
	...
	AQ.validators.isBankCategoryNameUnique = AS.core.createDerivedClass(
		YAHOO.ARISoft.validators.asyncValidator, {
			prepare: function() {
				...
				this.url = PM.adminBaseUrl + "index.php?option=com_ariquiz&view=bankcategory&task=ajaxIsCategoryNameUnique";
