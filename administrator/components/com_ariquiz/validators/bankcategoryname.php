...
class BankcategorynameValidator extends AriValidator
{
	...
	function registerScript($prefix, $validationGroups = array())
	{
		...
		$doc->addScriptDeclaration(
			...
			'	new YAHOO.ARISoft.Quiz.validators.isBankCategoryNameUnique("' . $ctrlId . '",' . $jsConfig . '))');
	...
	function registerAssets()
	{
		...
		$doc->addScript($uri . 'bankcategoryname.js');
	}
}