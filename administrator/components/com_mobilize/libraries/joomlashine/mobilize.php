...
class JSNMobilize
{
    ...
    function getItemsBlockContent($name)
    {
        ...
        if (!empty($mobilizeBlockContent) && count((array) $mobilizeBlockContent))
        {
    ...
    function getItemsMenuIcon($name, $title, $type = '', $icon = '', $style = '')
    {
        ...
        if($name == 'mobilize-menu'){
			...
			if (is_array($this->_contentData['mobilize-menu-language']) && count($this->_contentData['mobilize-menu-language']))
			{
