                    ...
                    <div class="jsn-mobilize">
                        <div class="jsn-form-bar">
                            ...
                            <div class="pull-right">
                                ...
                                $bttColor = '#EEEEEE';
                                $bttStyle = !empty( $this->_style->jsn_back_to_top ) ? ( ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_gpc') && get_magic_quotes_gpc() == true) || ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_runtime') && get_magic_quotes_runtime() == true) ) ? stripslashes( $this->_style->jsn_back_to_top ) : $this->_style->jsn_back_to_top : '{"show":"1","align":"center","text":"Back To Top","padding":"10","color":"#FFFFFF","background":"#000000"}';
                                $bttStyle = !empty( $this->_style->jsn_back_to_top ) ? ( ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_gpc') && get_magic_quotes_gpc() == true) || ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_runtime') && get_magic_quotes_runtime() == true) ) ? stripslashes( $this->_style->jsn_back_to_top ) : $this->_style->jsn_back_to_top : '{"show":"1","align":"center","text":"Back To Top","padding":"10","color":"#FFFFFF","background":"#000000"}';
                                                ...
                                                <div id="jsn-mobilize" class="jsn-layout">
                                                    ...
                                                    <div class="jsn-row-container row-fluid">
                                                        ...
                                                        <div class="jsn-iconbar jsn-vertical">
                                                            ...
                                                            <?php $styleMenu = ! empty( $this->_style->jsn_menu ) ? ( ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_gpc') && get_magic_quotes_gpc() == true) || ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_runtime') && get_magic_quotes_runtime() == true) ) ? stripslashes( $this->_style->jsn_menu ) : $this->_style->jsn_menu : ''; ?>
                                                    ...
                                                    <div class="jsn-row-container row-fluid">
                                                        ...
                                                        <div class="jsn-iconbar jsn-vertical">
                                                            ...
                                                            <?php $styleTool = ! empty( $this->_style->jsn_mobile_tool ) ? ( ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_gpc') && get_magic_quotes_gpc() == true) || ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_runtime') && get_magic_quotes_runtime() == true) ) ? stripslashes( $this->_style->jsn_mobile_tool ) : $this->_style->jsn_mobile_tool : ''; ?>
                                                    ...
                                                    <div class="jsn-row-container row-fluid">
                                                        ...
                                                        <div class="jsn-iconbar jsn-vertical">
                                                            <a data-action="module" title="<?php echo jText::_( 'JSN_MOBILIZE_EDIT_STYLE' );?>" href="javascript:void(0);"><i class="icon-pencil"></i></a>
                                                            <?php $styleContentTop = ! empty( $this->_style->jsn_content_top ) ? ( ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_gpc') && get_magic_quotes_gpc() == true) || ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_runtime') && get_magic_quotes_runtime() == true) ) ? stripslashes( $this->_style->jsn_content_top ) : $this->_style->jsn_content_top : ''; ?>
                                                    ...
                                                    <div class="jsn-row-container row-fluid">
                                                        ...
                                                        <div class="jsn-iconbar jsn-vertical">
                                                            ...
                                                            <?php $styleMainBody = ! empty( $this->_style->jsn_mainbody ) ? ( ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_gpc') && get_magic_quotes_gpc() == true) || ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_runtime') && get_magic_quotes_runtime() == true) ) ? stripslashes( $this->_style->jsn_mainbody ) : $this->_style->jsn_mainbody : ''; ?>
                                                    ...
                                                    <div class="jsn-row-container row-fluid">
                                                        ...
                                                        <div class="jsn-iconbar jsn-vertical">
                                                            <a data-action="module" title="<?php echo jText::_( 'JSN_MOBILIZE_EDIT_STYLE' );?>" href="javascript:void(0);"><i class="icon-pencil"></i></a>
                                                            <?php $styleUserTop = ! empty( $this->_style->jsn_user_top ) ? ( ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_gpc') && get_magic_quotes_gpc() == true) || ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_runtime') && get_magic_quotes_runtime() == true) ) ? stripslashes( $this->_style->jsn_user_top ) : $this->_style->jsn_user_top : ''; ?>
                                                    ...
                                                    <div class="jsn-row-container row-fluid">
                                                        ...
                                                        <div class="jsn-iconbar jsn-vertical">
                                                            <a data-action="module" title="<?php echo jText::_( 'JSN_MOBILIZE_EDIT_STYLE' );?>" href="javascript:void(0);"><i class="icon-pencil"></i></a>
                                                            <?php $styleUserBottom = ! empty( $this->_style->jsn_user_bottom ) ? ( ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_gpc') && get_magic_quotes_gpc() == true) || ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_runtime') && get_magic_quotes_runtime() == true) ) ? stripslashes( $this->_style->jsn_user_bottom ) : $this->_style->jsn_user_bottom : ''; ?>
                                                    ...
                                                    <div class="jsn-row-container row-fluid">
                                                        ...
                                                        <div class="jsn-iconbar jsn-vertical">
                                                            <a data-action="module" title="<?php echo jText::_( 'JSN_MOBILIZE_EDIT_STYLE' );?>" href="javascript:void(0);"><i class="icon-pencil"></i></a>
                                                            <?php $styleContentBottom = ! empty( $this->_style->jsn_content_bottom ) ? ( ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_gpc') && get_magic_quotes_gpc() == true) || ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_runtime') && get_magic_quotes_runtime() == true) ) ? stripslashes( $this->_style->jsn_content_bottom ) : $this->_style->jsn_content_bottom : ''; ?>
                                                    ...
                                                    <div class="jsn-total">
                                                        <div class="jsn-row-container row-fluid">
                                                            ...
                                                            <div class="jsn-iconbar jsn-vertical">
                                                                <a data-action="module" title="<?php echo jText::_( 'JSN_MOBILIZE_EDIT_STYLE' );?>" href="javascript:void(0);"><i class="icon-pencil"></i></a>
                                                                <?php $styleFooter = ! empty( $this->_style->jsn_footer ) ? ( ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_gpc') && get_magic_quotes_gpc() == true) || ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_runtime') && get_magic_quotes_runtime() == true) ) ? stripslashes( $this->_style->jsn_footer ) : $this->_style->jsn_footer : ''; ?>
                                                        ...
                                                        <div class="jsn-row-container row-fluid jsn-style">
                                                            <div id="jsn-style">
                                                                ...
                                                                <?php $style = ! empty( $this->_style->jsn_style ) ? ( ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_gpc') && get_magic_quotes_gpc() == true) || ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_runtime') && get_magic_quotes_runtime() == true) ) ? stripslashes( $this->_style->style ) : $this->_style->jsn_style : ''; ?>
                                                        ...
                                                        <div class="jsn-row-container row-fluid" >
                                                            <div id="jsn-social" class="jsn-column-container clearafter" >
                                                                <div class="social_div">
                                                                    <?php $social = ! empty( $this->_style->jsn_social ) ? ( ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_gpc') && get_magic_quotes_gpc() == true) || ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_runtime') && get_magic_quotes_runtime() == true) ) ? stripslashes( $this->_style->jsn_social ) : $this->_style->jsn_social : '';
                                                                    $cm = 0;
                                                                    if(isset($social) && !empty($social)):
                                                                        $arr = json_decode($social);
                                                                        foreach ($arr as $key=>$val):
                                                        ...
                                                        <div class="jsn-row-container row-fluid">
                                                            ...
                                                            <div class="jsn-iconbar jsn-vertical">
                                                                ...
                                                                <?php $styleSwitcher = ! empty( $this->_style->jsn_switcher ) ? ( ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_gpc') && get_magic_quotes_gpc() == true) || ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_runtime') && get_magic_quotes_runtime() == true) ) ? stripslashes( $this->_style->jsn_switcher ) : $this->_style->jsn_switcher : ''; ?>
