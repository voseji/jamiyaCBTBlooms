...
<div id="ariQueMainAnsContainer" class="aq-loading aq-quizsession-container<?php if (1 == $quizInfo->PageCount): ?> aq-one-page-quiz<?php endif; ?>">
	...
	<div class="aq-status-panel aq-hidden-onloading">
		...
		<div class="aq-timers-panel aq-right-pos aq-hidden-onloading" class="ariQuizTimeCnt" id="ariQuizTimeCnt" style="position:fixed; padding-left:560px; ">
		<?php
			if ($quizStorage->get('UseCalculator')):
		?>
		<a href="#"  class="btn" id="aCalc_<?php echo $quizInfo->QuizId; ?>"><i class="icon-calendar"></i>My Calculator</a>
		<?php
			endif;
		?><br/>
			...
			<div class="aq-quiz-timer" id="ariQuizTimer">
				<table class="aq-timer">
					...
					<tr>
						<td>
							<div id="ariQuizTimerHr" style="font-size:30px; width:100%; font-color:red"></div>
						</td>
						<td>
							<div id="ariQuizTimerMin"  style="font-size:50px; width:100%; color:red" >00</div>
						</td>
						<td>
							<div id="ariQuizTimerSec" >00</div>
						</td>
					</tr>
					<tr>
						</tr>
	...
	<div style="position: relative; width: 82%;" class="ariQuizMainContainer">
		<div class="aq-page-description aq-page-description-hidden aq-hidden-onloading" id="aqPageDescription">
			<div class="aq-page-description-label">Current Subject</div>
    ...
    <div class="aq-navbutton-panel pagination">
        ...
        ?>
            <li class="aq-navbutton-page<?php echo $pageIdx; ?>"><a href="#"  onclick="ariQuizQueManager.goToPage(<?php echo $pageIdx; ?>); return false;"><?php echo $pageIdx + 1; ?></a></li>
        <?php
            endfor;
        ?>
        </ul>
	...
	<div class="aq-button-panel">
		...
		?>
		<a  ref="#" class="btn" onclick=" if (ariQuizQueManager.validate()) ariQuizQueManager.savePage(); return false;"><i class="fa fa-tick" ></i> <?php echo JText::_('COM_ARIQUIZ_LABEL_SAVE'); ?></a>
	</div>
</div>
