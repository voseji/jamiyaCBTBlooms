<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:9156:"
<!DOCTYPE html>
<html lang="en-gb" dir="ltr"
	  class='com_content view-article itemid-118 j39 mm-hover '>

<head>
	<base href="http://10.12.0.100/index.php/staff-login-frontend" />
	...
	<script type="application/json" class="joomla-script-options new">{"csrf.token":"56cc150eca52da3e6c7324aad3271d7a","system.paths":{"root":"","base":""},"system.keepalive":{"interval":840000,"uri":"\/index.php\/component\/ajax\/?format=json"}}</script>
...
<header class="article-header clearfix">
	<h1 class="article-title" itemprop="headline">
					Staff Login Frontend			<meta itemprop="url" content="http://10.12.0.100/index.php/staff-login-frontend" />
			</h1>
  ...
  <!-- Aside -->
	...
	<section class="article-content clearfix">
		<p>	<form action="/index.php/staff-login-frontend" method="post" id="login-form">
			...
			<input type="hidden" name="56cc150eca52da3e6c7324aad3271d7a" value="1" />		</fieldset>
			</form>
</p>	</section>
