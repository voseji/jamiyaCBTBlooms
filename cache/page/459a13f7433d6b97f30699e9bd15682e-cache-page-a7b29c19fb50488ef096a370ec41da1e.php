...
<head>
	...
	<script type="application/json" class="joomla-script-options new">{"csrf.token":"5ece7de8bd6cf96a180392bad0053b14","system.paths":{"root":"","base":""}}</script>
...
<h1 class="aq-quiz-title aq-header">CCA YEAR 4</h1>
<br/>
...
<input type="hidden" name="quizId" value="62" />
				...
				<input type="hidden" name="5ece7de8bd6cf96a180392bad0053b14" value="1" />
				</form>
				</div>
		</div>
		<!-- //MAIN CONTENT -->
