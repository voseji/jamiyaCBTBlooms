...
<head>
	...
	<script type="application/json" class="joomla-script-options new">{"csrf.token":"653ae0391c807d9f05d55e8fdcb0b439","system.paths":{"root":"","base":""}}</script>
...
<input type="hidden" name="quizId" value="16" />
				...
				<input type="hidden" name="653ae0391c807d9f05d55e8fdcb0b439" value="1" />
				</form>
				</div>
		</div>
		<!-- //MAIN CONTENT -->
