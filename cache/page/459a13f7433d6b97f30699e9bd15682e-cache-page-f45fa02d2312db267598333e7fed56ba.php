...
<head>
	...
	<script type="application/json" class="joomla-script-options new">{"csrf.token":"3e39502359d82778fd5f26dbef38e5e9","system.paths":{"root":"","base":""},"system.keepalive":{"interval":840000,"uri":"\/index.php\/component\/ajax\/?format=json"},"joomla.jtext":{"JLIB_FORM_FIELD_INVALID":"Invalid field:&#160"}}</script>
	...
	Email Address<span class="star">&#160;*</span></label>
		...
		<div class="control-group">
			<div class="controls">
				...
				<input type="hidden" name="3e39502359d82778fd5f26dbef38e5e9" value="1" />			</div>
		</div>
	</form>
</div>
...
<div class="customslideshow"  >
    ...
    <div class="sclogin-joomla-login vertical span12">
            ...
            <fieldset class="input-block-level userdata">
                ...
                <input type="hidden" name="option" value="com_users"/><input type="hidden" name="task" value="user.login"/><input type="hidden" name="return" value="aW5kZXgucGhwP0l0ZW1pZD0xMDE="/><input type="hidden" name="mod_id" value="95"/><input type="hidden" name="3e39502359d82778fd5f26dbef38e5e9" value="1" />            </fieldset>
        </form>
    </div>
        </div>
