<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:8136:"
<!DOCTYPE html>
...
<input type="hidden" name="rurl" value="index.php?option=com_ariquiz&view=quizzes" />
				...
				<input type="hidden" name="1de297f4eb4193fcad08f69be9bdaae2" value="1" />
				</form>
				</div>
		</div>
		<!-- //MAIN CONTENT -->
