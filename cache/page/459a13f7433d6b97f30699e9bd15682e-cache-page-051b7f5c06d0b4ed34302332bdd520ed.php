<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:8097:"
<!DOCTYPE html>
...
<head>
	...
	<script type="application/json" class="joomla-script-options new">{"csrf.token":"dfd8a8b4d0736e8edbffaa4b32ec8770","system.paths":{"root":"","base":""}}</script>
...
<h1 class="aq-quiz-title aq-header">PHE YEAR 10 </h1>
<br/>
...
<input type="hidden" name="quizId" value="76" />
				...
				<input type="hidden" name="dfd8a8b4d0736e8edbffaa4b32ec8770" value="1" />
				</form>
				</div>
		</div>
		<!-- //MAIN CONTENT -->
