...
<head>
	...
	<title>ENGLISH LANGUAGE YEAR 4</title>
...
<h1 class="aq-quiz-title aq-header">ENGLISH LANGUAGE YEAR 4</h1>
<br/>

	<div class="aq-message-error">You do not have permissions to take this CBT exam</div>
	<br/><br/>

<input type="hidden" name="quizId" value="212" />
