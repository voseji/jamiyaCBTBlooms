<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:10151:"
<!DOCTYPE html>
<html lang="en-gb" dir="ltr"
	  class='com_sppagebuilder view-page itemid-115 home sp-preloader j39 mm-hover '>

<head>
	<base href="http://10.12.0.100/index.php" />
...
MathJax.Hub.Config({ TeX: { equationNumbers: {autoNumber: "AMS"} }, showMathMenu: false, messageStyle: "none" });
	...
	<meta property="og:url" content="http://10.12.0.100/index.php" />
...
<div class="customslideshow"  >
    ...
    <div class="sclogin-joomla-login vertical span12">
            ...
            <fieldset class="input-block-level userdata">
                ...
                <input type="hidden" name="option" value="com_users"/><input type="hidden" name="task" value="user.login"/><input type="hidden" name="return" value="aW5kZXgucGhwP0l0ZW1pZD0xMDE="/><input type="hidden" name="mod_id" value="95"/><input type="hidden" name="829acf6091aa9839bb7c496b748b4f14" value="1" />            </fieldset>
        </form>
    </div>
        </div>
