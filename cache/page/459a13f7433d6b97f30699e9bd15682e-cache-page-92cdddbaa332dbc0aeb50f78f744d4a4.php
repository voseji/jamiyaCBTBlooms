<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:7946:"
<!DOCTYPE html>
...
<head>
	...
	<script type="application/json" class="joomla-script-options new">{"csrf.token":"8070fcef5fc230e1bb627e49bc56a421","system.paths":{"root":"","base":""}}</script>
...
<h1 class="aq-quiz-title aq-header">Sample</h1>
<br/>

	<div class="aq-message-error">You do not have permissions to take this CBT exam</div>
	<br/><br/>

<input type="hidden" name="quizId" value="140" />
				...
				<input type="hidden" name="8070fcef5fc230e1bb627e49bc56a421" value="1" />
				</form>
				</div>
		</div>
		<!-- //MAIN CONTENT -->
