...
<head>
	...
	<script type="application/json" class="joomla-script-options new">{"csrf.token":"3a225c0e085ca1f7339622266bcf72a7","system.paths":{"root":"","base":""}}</script>
...
<h1 class="aq-quiz-title aq-header">BIOLOGY  YEAR 11</h1>
<br/>
...
<input type="hidden" name="quizId" value="91" />
				...
				<input type="hidden" name="3a225c0e085ca1f7339622266bcf72a7" value="1" />
				</form>
				</div>
		</div>
		<!-- //MAIN CONTENT -->
