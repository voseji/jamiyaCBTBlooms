...
<head>
	...
	<script type="application/json" class="joomla-script-options new">{"csrf.token":"24bdde9542a0196be8ee2ff87526f06d","system.paths":{"root":"","base":""}}</script>
...
<h1 class="aq-quiz-title aq-header">HISTORY YEAR 10</h1>
<br/>
...
<input type="hidden" name="quizId" value="72" />
				...
				<input type="hidden" name="24bdde9542a0196be8ee2ff87526f06d" value="1" />
				</form>
				</div>
		</div>
		<!-- //MAIN CONTENT -->
