...
<head>
	...
	<script type="application/json" class="joomla-script-options new">{"csrf.token":"add96f7d3975a51235500dacb4dfc1a2","system.paths":{"root":"","base":""}}</script>
...
<input type="hidden" name="quizId" value="433" />
				...
				<input type="hidden" name="add96f7d3975a51235500dacb4dfc1a2" value="1" />
				</form>
				</div>
		</div>
		<!-- //MAIN CONTENT -->
