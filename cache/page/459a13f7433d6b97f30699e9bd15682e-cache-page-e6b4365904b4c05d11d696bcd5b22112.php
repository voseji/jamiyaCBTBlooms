...
<head>
	...
	<title>3RD TERM CRS YEAR 8</title>
	...
	<script type="application/json" class="joomla-script-options new">{"csrf.token":"a3a8016d4daa95614908b7b0a9e181d0","system.paths":{"root":"","base":""}}</script>
...
<h1 class="aq-quiz-title aq-header">3RD TERM CRS YEAR 8</h1>
<br/>

	<div class="aq-message-error">You do not have permissions to take this CBT exam</div>
	<br/><br/>

<input type="hidden" name="quizId" value="496" />
				...
				<input type="hidden" name="a3a8016d4daa95614908b7b0a9e181d0" value="1" />
				</form>
				</div>
		</div>
		<!-- //MAIN CONTENT -->
