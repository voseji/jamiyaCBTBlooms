<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:9152:"
<!DOCTYPE html>
<html lang="en-gb" dir="ltr"
	  class='com_content view-article itemid-118 j39 mm-hover '>

<head>
	<base href="http://localhost/index.php/staff-login-frontend" />
	...
	<script type="application/json" class="joomla-script-options new">{"csrf.token":"fc38ac6e57adcb1f7c20d11c93555369","system.paths":{"root":"","base":""},"system.keepalive":{"interval":840000,"uri":"\/index.php\/component\/ajax\/?format=json"}}</script>
...
<header class="article-header clearfix">
	<h1 class="article-title" itemprop="headline">
					Staff Login Frontend			<meta itemprop="url" content="http://localhost/index.php/staff-login-frontend" />
			</h1>
  ...
  <!-- Aside -->
	...
	<section class="article-content clearfix">
		<p>	<form action="/index.php/staff-login-frontend" method="post" id="login-form">
			...
			<input type="hidden" name="fc38ac6e57adcb1f7c20d11c93555369" value="1" />		</fieldset>
			</form>
</p>	</section>
