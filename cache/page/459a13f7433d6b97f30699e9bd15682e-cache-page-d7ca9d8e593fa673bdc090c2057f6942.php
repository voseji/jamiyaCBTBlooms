...
<head>
	...
	<script type="application/json" class="joomla-script-options new">{"csrf.token":"00997d6f71a437f67398b09f46a8782a","system.paths":{"root":"","base":""}}</script>
...
<input type="hidden" name="quizId" value="24" />
				...
				<input type="hidden" name="00997d6f71a437f67398b09f46a8782a" value="1" />
				</form>
				</div>
		</div>
		<!-- //MAIN CONTENT -->
