<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:8142:"
<!DOCTYPE html>
...
<head>
	...
	<title>2ND  TERM ISLAMIC STUDIES YEAR 8</title>
	...
	<script type="application/json" class="joomla-script-options new">{"csrf.token":"1b5213ff3203ea9e855062986ce6cc23","system.paths":{"root":"","base":""}}</script>
...
<h1 class="aq-quiz-title aq-header">2ND  TERM ISLAMIC STUDIES YEAR 8</h1>
<br/>
...
<input type="hidden" name="quizId" value="357" />
				...
				<input type="hidden" name="1b5213ff3203ea9e855062986ce6cc23" value="1" />
				</form>
				</div>
		</div>
		<!-- //MAIN CONTENT -->
