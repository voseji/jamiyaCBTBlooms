<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:10546:"
<!DOCTYPE html>
<html lang="en-gb" dir="ltr"
	  class='com_ariquiz view-message itemid-101 j39 mm-hover '>
...
<head>
	...
	<script type="application/json" class="joomla-script-options new">{"csrf.token":"30d872a5ca140b788e724d09afe830de","system.paths":{"root":"","base":""},"system.keepalive":{"interval":840000,"uri":"\/index.php\/component\/ajax\/?format=json"}}</script>
...
You don't have access to the CBT exam session because you are logged out or logged under another user.</div>
<br/><br/>
<a href="#" class="btn aq-button" onclick="YAHOO.ARISoft.page.pageManager.submitForm('gotopage'); return false;">Return <i class="icon-circle-arrow-right"></i></a>

<input type="hidden" name="rurl" value="index.php?option=com_ariquiz&view=quizzes" />

				<input type="hidden" name="option" value="com_ariquiz" />
				<input type="hidden" name="view" value="message" />
				<input type="hidden" name="task" value="" />
				<input type="hidden" name="30d872a5ca140b788e724d09afe830de" value="1" />
				</form>
				</div>
		</div>
		<!-- //MAIN CONTENT -->
		...
		<div class="t3-sidebar t3-sidebar-right col-xs-12 col-sm-4  col-md-3 ">
			...
			<input type="hidden" name="30d872a5ca140b788e724d09afe830de" value="1" />		</fieldset>
			</form>
</div></div></div>
		</div>
		<!-- //SIDEBAR RIGHT -->
