<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:11234:"
<!DOCTYPE html>
<html lang="en-gb" dir="ltr"
	  class='com_users view-remind itemid-115 j39 mm-hover '>

<head>
	<base href="http://10.12.0.100/index.php/component/users/" />
	...
	<script type="application/json" class="joomla-script-options new">{"csrf.token":"56cc150eca52da3e6c7324aad3271d7a","system.paths":{"root":"","base":""},"system.keepalive":{"interval":840000,"uri":"\/index.php\/component\/ajax\/?format=json"},"joomla.jtext":{"JLIB_FORM_FIELD_INVALID":"Invalid field:&#160"}}</script>
...
<div class="control-group">
 ...
 size="30"    autocomplete="email"    required aria-required="true"  />	</div>
			...
			<div class="controls">
				...
				<input type="hidden" name="56cc150eca52da3e6c7324aad3271d7a" value="1" />			</div>
		</div>
	</form>
</div>
...
<div class="customslideshow"  >
    ...
    <div class="sclogin-joomla-login vertical span12">
            ...
            <fieldset class="input-block-level userdata">
                ...
                <input type="hidden" name="option" value="com_users"/><input type="hidden" name="task" value="user.login"/><input type="hidden" name="return" value="aW5kZXgucGhwP0l0ZW1pZD0xMDE="/><input type="hidden" name="mod_id" value="95"/><input type="hidden" name="56cc150eca52da3e6c7324aad3271d7a" value="1" />            </fieldset>
        </form>
    </div>
        </div>
