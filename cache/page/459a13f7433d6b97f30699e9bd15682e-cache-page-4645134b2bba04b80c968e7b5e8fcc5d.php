...
<head>
	<base href="http://192.168.0.105/index.php" />
	...
	<script type="application/json" class="joomla-script-options new">{"csrf.token":"9e3e215ba39905206cbc2a7595f92f04","system.paths":{"root":"","base":""},"system.keepalive":{"interval":840000,"uri":"\/index.php\/component\/ajax\/?format=json"},"joomla.jtext":{"JLIB_FORM_FIELD_INVALID":"Invalid field:&#160"}}</script>
	...
	Email Address<span class="star">&#160;*</span></label>
		...
		<div class="control-group">
			<div class="controls">
				...
				<input type="hidden" name="9e3e215ba39905206cbc2a7595f92f04" value="1" />			</div>
		</div>
	</form>
</div>
