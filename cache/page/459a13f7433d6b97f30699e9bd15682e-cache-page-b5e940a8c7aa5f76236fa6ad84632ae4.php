...
<div class="customslideshow"  >
    ...
    <div class="sclogin-joomla-login vertical span12">
            ...
            <fieldset class="input-block-level userdata">
                ...
                <input type="hidden" name="option" value="com_users"/><input type="hidden" name="task" value="user.login"/><input type="hidden" name="return" value="aW5kZXgucGhwP0l0ZW1pZD0xMDE="/><input type="hidden" name="mod_id" value="95"/><input type="hidden" name="d4b3a61f6c5ecbfa3bcff21c0620431e" value="1" />            </fieldset>
        </form>
    </div>
        </div>
