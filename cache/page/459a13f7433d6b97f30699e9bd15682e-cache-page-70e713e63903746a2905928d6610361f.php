...
<head>
	<base href="http://192.168.0.105/index.php/staff-login-frontend" />
	...
	<script type="application/json" class="joomla-script-options new">{"csrf.token":"82849c1031051d30bb5bf48a7ea8430d","system.paths":{"root":"","base":""},"system.keepalive":{"interval":840000,"uri":"\/index.php\/component\/ajax\/?format=json"}}</script>
...
<header class="article-header clearfix">
	<h1 class="article-title" itemprop="headline">
					Staff Login Frontend			<meta itemprop="url" content="http://192.168.0.105/index.php/staff-login-frontend" />
			</h1>
  ...
  <!-- Aside -->
	...
	<section class="article-content clearfix">
		<p>	<form action="/index.php/staff-login-frontend" method="post" id="login-form">
			...
			<input type="hidden" name="82849c1031051d30bb5bf48a7ea8430d" value="1" />		</fieldset>
			</form>
</p>	</section>
