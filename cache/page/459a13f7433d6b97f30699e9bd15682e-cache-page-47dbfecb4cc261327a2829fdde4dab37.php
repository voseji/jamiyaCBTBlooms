<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:10592:"
<!DOCTYPE html>
...
<head>
	...
	<meta name="description" content="Attempt all questions. All questions carry equal marks. " />
	<meta name="generator" content="Joomla! - Open Source Content Management" />
	<title>3RD TERM BASIC SCIENCE YEAR 7</title>
	...
	<script type="application/json" class="joomla-script-options new">{"csrf.token":"34e3e6cba7a44e4253c3d32b0a1769e6","system.paths":{"root":"","base":""},"system.keepalive":{"interval":840000,"uri":"\/index.php\/component\/ajax\/?format=json"}}</script>
...
<h1 class="aq-quiz-title aq-header">3RD TERM BASIC SCIENCE YEAR 7</h1>
<br/>
<div class="aq-quiz-description"><p>Attempt all questions. All questions carry equal marks. </p></div>
<br/><br/>

	<div class="aq-message-error">You do not have permissions to take this CBT exam</div>
	<br/><br/>

<input type="hidden" name="quizId" value="483" />
				...
				<input type="hidden" name="34e3e6cba7a44e4253c3d32b0a1769e6" value="1" />
				</form>
				</div>
		</div>
		<!-- //MAIN CONTENT -->
		...
		<div class="t3-sidebar t3-sidebar-right col-xs-12 col-sm-4  col-md-3 ">
			...
			<input type="hidden" name="34e3e6cba7a44e4253c3d32b0a1769e6" value="1" />		</fieldset>
			</form>
</div></div></div>
		</div>
		<!-- //SIDEBAR RIGHT -->
