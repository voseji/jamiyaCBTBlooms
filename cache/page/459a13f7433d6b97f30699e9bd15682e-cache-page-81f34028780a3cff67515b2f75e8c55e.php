<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:10715:"
<!DOCTYPE html>
<html lang="en-gb" dir="ltr"
	  class='com_ariquiz view-quiz itemid-101 j39 mm-hover '>

<head>
	<base href="http://192.168.0.171/" />
	<meta http-equiv="content-type" content="text/html; charset=utf-8" />
	<meta name="description" content="Answer all questions. Carefully choose the correct options and shade appropriately the boxes provided on your answer sheet" />
	<meta name="generator" content="Joomla! - Open Source Content Management" />
	<title>BIOLOGY  YEAR 10</title>
	...
	<script type="application/json" class="joomla-script-options new">{"csrf.token":"ce59a28554b09fc8adaf67039e434d49","system.paths":{"root":"","base":""},"system.keepalive":{"interval":840000,"uri":"\/index.php\/component\/ajax\/?format=json"}}</script>
...
<h1 class="aq-quiz-title aq-header">BIOLOGY  YEAR 10</h1>
<br/>
<div class="aq-quiz-description"><p><strong>Answer all questions. Carefully choose the correct options and shade appropriately the boxes provided on your answer sheet</strong></p></div>
<br/><br/>

	<div class="aq-message-error">You do not have permissions to take this CBT exam</div>
	<br/><br/>

<input type="hidden" name="quizId" value="92" />
				...
				<input type="hidden" name="ce59a28554b09fc8adaf67039e434d49" value="1" />
				</form>
				</div>
		</div>
		<!-- //MAIN CONTENT -->
		...
		<div class="t3-sidebar t3-sidebar-right col-xs-12 col-sm-4  col-md-3 ">
			...
			<input type="hidden" name="ce59a28554b09fc8adaf67039e434d49" value="1" />		</fieldset>
			</form>
</div></div></div>
		</div>
		<!-- //SIDEBAR RIGHT -->
