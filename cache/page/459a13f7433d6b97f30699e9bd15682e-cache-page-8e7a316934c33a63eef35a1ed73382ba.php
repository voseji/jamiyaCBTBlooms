...
<head>
	...
	<title>3RD TERM EXAMINATION IRS YEAR 8</title>
	...
	<script type="application/json" class="joomla-script-options new">{"csrf.token":"77c4c94694aaed530a2ad564ece2487c","system.paths":{"root":"","base":""}}</script>
...
<h1 class="aq-quiz-title aq-header">3RD TERM EXAMINATION IRS YEAR 8</h1>
<br/>

	<div class="aq-message-error">You do not have permissions to take this CBT exam</div>
	<br/><br/>

<input type="hidden" name="quizId" value="529" />
				...
				<input type="hidden" name="77c4c94694aaed530a2ad564ece2487c" value="1" />
				</form>
				</div>
		</div>
		<!-- //MAIN CONTENT -->
