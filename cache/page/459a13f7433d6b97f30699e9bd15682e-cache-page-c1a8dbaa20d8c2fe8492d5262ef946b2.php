...
<div class="customslideshow"  >
    ...
    <div class="sclogin-joomla-login vertical span12">
            ...
            <fieldset class="input-block-level userdata">
                ...
                <input type="hidden" name="option" value="com_users"/><input type="hidden" name="task" value="user.login"/><input type="hidden" name="return" value="aW5kZXgucGhwP0l0ZW1pZD0xMDE="/><input type="hidden" name="mod_id" value="95"/><input type="hidden" name="681e7c240859fb4f534b4cba53065ef9" value="1" />            </fieldset>
        </form>
    </div>
        </div>
