<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:8096:"
<!DOCTYPE html>
...
<head>
	...
	<script type="application/json" class="joomla-script-options new">{"csrf.token":"f0733ce0d99334159e41017185976409","system.paths":{"root":"","base":""}}</script>
...
<h1 class="aq-quiz-title aq-header">PHE YEAR 5</h1>
<br/>
...
<input type="hidden" name="quizId" value="186" />
				...
				<input type="hidden" name="f0733ce0d99334159e41017185976409" value="1" />
				</form>
				</div>
		</div>
		<!-- //MAIN CONTENT -->
