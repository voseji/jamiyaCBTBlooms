...
<head>
	...
	<title>2ND TERM EXAMINATION VISUAL ART YEAR 11</title>
	...
	<script type="application/json" class="joomla-script-options new">{"csrf.token":"3b42fe79765df0201252b9b09637e96c","system.paths":{"root":"","base":""}}</script>
...
<h1 class="aq-quiz-title aq-header">2ND TERM EXAMINATION VISUAL ART YEAR 11</h1>
<br/>

	<div class="aq-message-error">You do not have permissions to take this CBT exam</div>
	<br/><br/>

<input type="hidden" name="quizId" value="385" />
				...
				<input type="hidden" name="3b42fe79765df0201252b9b09637e96c" value="1" />
				</form>
				</div>
		</div>
		<!-- //MAIN CONTENT -->
