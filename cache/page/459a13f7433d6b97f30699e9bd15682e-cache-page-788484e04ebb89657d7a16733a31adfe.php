...
<head>
	...
	<script type="application/json" class="joomla-script-options new">{"csrf.token":"e418b6dd0ae9ee2de01ab16af17b568d","system.paths":{"root":"","base":""}}</script>
...
<input type="hidden" name="quizId" value="252" />
				...
				<input type="hidden" name="e418b6dd0ae9ee2de01ab16af17b568d" value="1" />
				</form>
				</div>
		</div>
		<!-- //MAIN CONTENT -->
