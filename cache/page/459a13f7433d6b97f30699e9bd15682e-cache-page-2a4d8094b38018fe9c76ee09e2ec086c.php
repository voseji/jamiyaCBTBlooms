...
<head>
	...
	<script type="application/json" class="joomla-script-options new">{"csrf.token":"bac4a1ac6fe7a506edadc3cd2e9eddb2","system.paths":{"root":"","base":""},"system.keepalive":{"interval":840000,"uri":"\/index.php\/component\/ajax\/?format=json"}}</script>
...
<input type="hidden" name="rurl" value="index.php?option=com_ariquiz&view=quizzes" />
				...
				<input type="hidden" name="bac4a1ac6fe7a506edadc3cd2e9eddb2" value="1" />
				</form>
				</div>
		</div>
		<!-- //MAIN CONTENT -->
		...
		<div class="t3-sidebar t3-sidebar-right col-xs-12 col-sm-4  col-md-3 ">
			...
			<input type="hidden" name="bac4a1ac6fe7a506edadc3cd2e9eddb2" value="1" />		</fieldset>
			</form>
</div></div></div>
		</div>
		<!-- //SIDEBAR RIGHT -->
