...
<head>
	...
	<title>2ND TERM HAUSA  YEAR 4</title>
	...
	<script type="application/json" class="joomla-script-options new">{"csrf.token":"49a3867af120711410b574cb844ffb3a","system.paths":{"root":"","base":""}}</script>
...
<h1 class="aq-quiz-title aq-header">2ND TERM HAUSA  YEAR 4</h1>
<br/>

	<div class="aq-message-error">You do not have permissions to take this CBT exam</div>
	<br/><br/>

<input type="hidden" name="quizId" value="349" />
				...
				<input type="hidden" name="49a3867af120711410b574cb844ffb3a" value="1" />
				</form>
				</div>
		</div>
		<!-- //MAIN CONTENT -->
