...
<head>
	...
	<title>CREATIVE ARTS YEAR 8</title>
...
<h1 class="aq-quiz-title aq-header">CREATIVE ARTS YEAR 8</h1>
<br/>

	<div class="aq-message-error">You do not have permissions to take this CBT exam</div>
	<br/><br/>

<input type="hidden" name="quizId" value="209" />
				...
				<input type="hidden" name="223a866c68a026b6a9553752cc952a9c" value="1" />
				</form>
				</div>
		</div>
		<!-- //MAIN CONTENT -->
