...
<form action="<?php echo JRoute::_('index.php', true, $params->get('usesecure', 0)); ?>" method="post" id="login-form" class="form-inline">
	...
	<?php endif; ?>
	<div class="userdata" style="position:fixed">
			...
			<div class="controls">
				<?php if (!$params->get('usetext', 0)) : ?>
					<div class="input-prepend">
						...
						<input id="modlgn-username" type="text" name="username" class="input-small" tabindex="0" size="18" placeholder="Registration Number" />
					</div>
				<?php else : ?>
			...
			<div class="controls">
				<?php if (!$params->get('usetext', 0)) : ?>
					<div class="input-prepend">
						...
						<input id="modlgn-passwd" type="hidden" value="school" name="password" class="input-small" tabindex="0" size="18" placeholder="<?php echo JText::_('JGLOBAL_PASSWORD'); ?>" />
					</div>
				<?php else : ?>
