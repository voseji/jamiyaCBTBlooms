        ...
        <form action="<?php echo $action; ?>" method="post" id="sclogin-form<?php echo $module->id; ?>">
            <fieldset class="input-block-level userdata">
                ...
                <div class="control-group form-sclogin-password" id="form-sclogin-password-<?php echo $module->id; ?>">
                    <div class="controls input-block-level">
                        <div class="input-append input-block-level">
                            <input value="password" id="sclogin-passwd<?php echo $module->id; ?>" name="<?php echo $passwordName; ?>" tabindex="0" class="sclogin-passwd input-block-level" title="password" type="hidden"
                ...
                <?php if (PluginHelper::isEnabled('system', 'remember')) :
                    ...
                    { ?>
                        <input id="sclogin-remember-<?php echo $module->id; ?>" type="hidden" name="remember" class="inputbox sclogin-remember" value="yes" title="Remember Me" />
                    <?php }
                endif; ?>
